...
modality-decoupled transformers and unified autoregressive-plus-diffusion models;
the cognitive loop and physics flywheel build on the world-models tradition; and
the physical-AI framing tracks a recent wave of world foundation models. Some of
...
generation, and action for physical AI.
